...
const projects = [
  {
    ...
    title: "Strength Training",
    description:
      "My programs are designed to help individuals enhance their physical capabilities...",
    images: [project1Img1, project1Img3, project1Img4, project1Img2, project1Img5, project1Img7],
  },
  {
    id: 2,
    title: "Personal Training",
    description:
      "As a personal trainer, I provide customized workout plans, one-on-one guidance...",
    images: [project2Img1, project2Img2, project2Img3, project2Img4, project2Img5, project2Img6, project2Img7, project2Img8],
  },
  {
    id: 3,
    title: "Nutritionist",
    description:
      "As a nutritionist, I specialize in creating personalized nutrition plans...",
    images: [project3Img1, project3Img2, project3Img3, project3Img4, project3Img5],
  },
  {
    id: 4,
    title: "Stage Shows",
    description:
      "At Sam's Gym, we take fitness beyond the gym by participating in high-energy stage shows...",
    images: [project4Img1, project4Img2, project4Img3, project4Img4, project4Img5, project4Img6, project4Img7, project4Img8, project4Img9, project4Img10],
  }
];
...
export const Portfolio = () => {
  ...
  // Drag-to-Scroll Handlers with improved smoothness
  const handleMouseDown = (e: React.MouseEvent) => {
  ...
  const handleMouseMove = (e: React.MouseEvent) => {
    ...
    e.preventDefault();
    const x = e.pageX - sliderRef.current.offsetLeft;
    const walk = (x - startX.current) * 1.5; // Adjusted speed factor
    sliderRef.current.scrollLeft = scrollLeft.current - walk;
  };
  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4 grid lg:grid-cols-2 gap-12">
        ...
        {/* Horizontal Image Slider - Adjusted Position */}
        <div
          ref={sliderRef}
          className="overflow-x-auto cursor-grab select-none whitespace-nowrap flex mt-[-50px] px-2 py-4"
          onMouseDown={handleMouseDown}
          onMouseMove={handleMouseMove}
          onMouseUp={handleMouseUpOrLeave}
          onMouseLeave={handleMouseUpOrLeave}
